...
public class TFIDFAnalyzer
{
	...
	public List<Keyword> analyze(String content,int topN){
		...
		if(stopWordsSet==null) {
			...
			loadStopWords(stopWordsSet, this.getClass().getResourceAsStream("/data/Jieba/stop_words.txt"));
		}
		if(idfMap==null) {
			idfMap=new HashMap<>();
			loadIDFMap(idfMap, this.getClass().getResourceAsStream("/data/Jieba/idf_dict.txt"));
		}
